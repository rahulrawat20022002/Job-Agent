...
## AI Systems Engineer, Working Student

Master's student in Data Science and Analytics at SRH Heidelberg, based in Mannheim, with hands on experience designing, deploying and maintaining production ready AI powered applications and agents. I built a multi agent LangGraph system with independent agents for language detection, retrieval, generation and evaluation, and a fully automated cloud pipeline that runs unattended end to end with 0 manual interventions required. Comfortable turning business requirements into working AI powered software, end to end in Python.
